...
class Parser:
    ...
    def judge_cmd(self,cmd):
        """parse command"""
        self.data = {'server_chunks': {}, 'action': {}, 'file': {}}
        cmds = cmd.split()
        flag = False
